...
interface DrawCircleService : KGEExtensibleService {
    fun drawCircle(
        center: Int2D,
        radius: Int,
    ...
    companion object : DrawCircleService by KGEExtensibleService.getOptionalWithHigherPriority()
        ?: originalDrawCircleServiceImplementation
}

val originalDrawCircleServiceImplementation: DrawCircleService
    get() = DefaultDrawCircleService

private data object DefaultDrawCircleService : DrawCircleService {
