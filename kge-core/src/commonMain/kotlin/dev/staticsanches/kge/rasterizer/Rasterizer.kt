 ...
 * the single call site that aggregates the four raster sub-services.
 *
 ...
 * through), [OutlineService] (lines, rectangle rings, circles and triangle
 * outlines), [FillService] (solid rectangles, circles, triangles) and
 * [DrawSpriteService] (blits). A composite primitive resolves its sub-draws
 * through the *active* sub-service, so a decorator override of any
 * sub-service is observed by the composites that consume it too. This
