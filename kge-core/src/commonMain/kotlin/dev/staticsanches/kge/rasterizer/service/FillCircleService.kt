...
interface FillCircleService : KGEExtensibleService {
    fun fillCircle(
        center: Int2D,
        radius: Int,
    ...
    companion object : FillCircleService by KGEExtensibleService.getOptionalWithHigherPriority()
        ?: originalFillCircleServiceImplementation
}

val originalFillCircleServiceImplementation: FillCircleService
    get() = DefaultFillCircleService

private data object DefaultFillCircleService : FillCircleService {
