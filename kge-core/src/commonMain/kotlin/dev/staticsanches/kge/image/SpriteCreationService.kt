 ...
 * [MemoryAllocatorService], so an allocator override covers surfaces too.
 * PNG loading/encoding is S5, a separate concept.
 */
interface SpriteCreationService : KGEOverridable {
    /**
     * Creates a [width]x[height] surface, its storage allocated through the
     * current [MemoryAllocatorService]; content is unspecified until written.
     *
...
/** Platform-independent default — allocation goes through [MemoryAllocatorService]. */
