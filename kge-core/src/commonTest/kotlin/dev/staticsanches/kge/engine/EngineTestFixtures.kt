...
internal val testWindowConfig = WindowConfig(screenWidth = 320, screenHeight = 240)

/** A [DriverService] handing out one recorded driver and counting creations. */
internal class FakeDriverService(
...
internal fun installDriver(driver: Driver): FakeDriverService {
    val service = FakeDriverService(driver)
    DriverService.override(service)
    return service
}

internal fun installGl(): RecordingGLService {
