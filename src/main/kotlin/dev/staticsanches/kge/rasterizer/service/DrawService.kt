...
interface DrawService : KGESPIExtensible {
	...
	fun draw(position: Int2D, color: Pixel, target: PixelMap, pixelMode: Pixel.Mode): Boolean

	fun draw(x: Int, y: Int, color: Pixel, target: PixelMap, pixelMode: Pixel.Mode): Boolean
...
internal class DefaultDrawService : DrawService {
	...
	override fun draw(x: Int, y: Int, color: Pixel, target: PixelMap, pixelMode: Pixel.Mode): Boolean =
		when (pixelMode) {
